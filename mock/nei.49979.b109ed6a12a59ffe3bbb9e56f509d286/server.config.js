...
module.exports = {
    /* 根目录 */
    webRoot: '/Users/rhea/project/test-project/',
    /* 视图目录 */
    viewRoot: '',
    /* 路由 */
    routes: {
        //"ALL /api/*": "代理所有接口, 这里输入代理服务器地址",
        "GET /api/test": { path: 'get/api/test/data', id: 264710, group: '默认分组' },
    },
    /* 注入给页面的模型数据的服务器配置 */
    // modelServer: {
    //     // 完整的主机地址，包括协议、主机名、端口
    ...
    /* 项目的 key */
    projectKey: 'b109ed6a12a59ffe3bbb9e56f509d286',
    /* 同步模块mock数据路径 */
    mockTpl: '',
    /* 异步接口mock数据路径 */
    mockApi: '/Users/rhea/project/test-project/mock/',
    /* 是否修改代理的host */
    changeOrigin: true,
    /* 模板后缀 */
    viewExt: '.ftl',
